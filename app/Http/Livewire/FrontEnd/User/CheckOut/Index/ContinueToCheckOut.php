...
{
    public $account, $payment_method = [], $billing_address_id, $available_e_wallet=[], $tmp_payment_intent_id=null, $billing_details=[], $pickup_option = '';
    ...
    protected $listeners = [
        ...
        'set_pickup_option'      => 'set_pickup_option'
    ];
    ...
    public function set_pickup_option($pickup_option){
        ...
        if(!empty($this->billing_address_id)){
            if(!empty($this->pickup_option)){
                        ...
                        if($payment_method['payment_method'] == 'e_wallet'){
                            ...
                            if(!in_array($payment_method['payment_e_wallet'], $available_ewallet)){
                                ...
                                $this->emit('alert', [
                                    'type'    => 'error',
                                    'title'   => 'Oops...',
                                    'message' => 'Please select your e-wallet.'
                                ]);
                                return false;
                            }
                        }
                        ...
                        try{
                            ...
                            if($billing->save()){
                                ...
                                foreach($cart['partner_products'] as $cart_key => $cart_row){
                                    ...
                                    $order->pickup_option = $this->pickup_option;
                ...
                $this->emit('alert', [
                    'type'    => 'error',
                    'title'   => 'Failed!',
                    'message' => 'Please select your pickup option.'
                ]);
            }
        }else{
            $this->emit('remove_loading_card', true);
