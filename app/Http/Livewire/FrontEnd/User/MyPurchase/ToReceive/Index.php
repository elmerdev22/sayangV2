...
namespace App\Http\Livewire\FrontEnd\User\MyPurchase\ToReceive;
...
class Index extends Component
{
    ...
    public function data(){
		...
		$filter['where_in'][] = [
			'field'  => 'orders.status',
			'values' => ['to_receive', 'payment_confirmed']
		];
    ...
    public function render(){
        ...
        return view('livewire.front-end.user.my-purchase.to-receive.index', compact('data'));
    }
