...
namespace App\Http\Livewire\FrontEnd\Partner\OrderAndReceipt\Cancelled;
...
class Index extends Component
{
    ...
    public function data(){
		...
		$filter['where']['orders.status']     = 'cancelled';
    ...
    public function render(){
        ...
        return view('livewire.front-end.partner.order-and-receipt.cancelled.index', compact('data'));
    }
