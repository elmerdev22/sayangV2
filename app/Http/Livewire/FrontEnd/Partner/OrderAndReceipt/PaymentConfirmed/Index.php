...
namespace App\Http\Livewire\FrontEnd\Partner\OrderAndReceipt\PaymentConfirmed;
...
class Index extends Component
{
    ...
    public function data(){
		...
		$filter['where']['orders.status']     = 'payment_confirmed';
    ...
    public function render(){
        ...
        return view('livewire.front-end.partner.order-and-receipt.payment-confirmed.index', compact('data'));
    }
