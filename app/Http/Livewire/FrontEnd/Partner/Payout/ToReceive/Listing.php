...
namespace App\Http\Livewire\FrontEnd\Partner\Payout\ToReceive;
...
class Listing extends Component
{
    ...
    public function render(){
        ...
        return view('livewire.front-end.partner.payout.to-receive.listing', compact('data', 'partners', 'component'));
    }
