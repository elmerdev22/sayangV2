...
namespace App\Http\Livewire\FrontEnd\Partner\Payout\Completed;
...
class Listing extends Component
{
    ...
    public function render(){
        ...
        return view('livewire.front-end.partner.payout.completed.listing', compact('data', 'partners', 'component'));
    }
