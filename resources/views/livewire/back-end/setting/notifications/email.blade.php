<div>
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="edit-email-notification" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form role="form" wire:submit.prevent="save">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Subject</label>
                            <input type="text" class="form-control" placeholder="Input here..." wire:model.lazy="subject">
                            @error('subject')
