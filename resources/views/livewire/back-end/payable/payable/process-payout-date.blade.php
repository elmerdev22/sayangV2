    ...
    <form method="POST" wire:submit.prevent="update">
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="date" class="form-control @error('date_from') is-invalid @enderror" id="order_date_from" wire:model="date_from">
                @error('date_from')  
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="form-control @error('date_to') is-invalid @enderror" id="order_date_to" wire:model="date_to" @if($date_from) min="{{$date_from}}" @endif>
                @error('date_to')  
                    <span class="invalid-feedback">
                        <span>{{$message}}</span>
                    </span>
