            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="form-group">
                        <label for="representative_id">Representative ID* 
                            <span wire:loading wire:target="file, upload" class="fas fa-spinner fa-spin"></span>
                        </label>
                        <input type="file" id="representative_id" class="form-control-file @if($error) is-invalid @else @error('file') is-invalid @enderror @endif" accept=".png, .jpeg, .jpg, .gif, .docx, .pdf" wire:model="file">
                        <div>
