    ...
    GlassCase.prototype = {
        init: function (options) {
            ...
            var ctntDisplayArea = "<div class='gc-display-area'>" +
                                        "<div class='gc-icon gc-icon-next text-center'><span class='fas fa-sm fa-chevron-right'></span></div>" +
                                        "<div class='gc-icon gc-icon-prev text-center'><span class='fas fa-sm fa-chevron-left'></span></div>" +
            ...
            var ctntOverlayArea = "<div class='gc-overlay-area'>" +
                                    "<div class='gc-overlay-top-icons'>" +
                                     "<div class='gc-icon gc-icon-close text-center'><span class='fas fa-times fa-xs'></span></div>" +
                                        "<div class='gc-icon gc-icon-enlarge text-center'><span class='fas fa-search-plus fa-xs'></span></div>" +
                                        "<div class='gc-icon gc-icon-compress text-center'><span class='fas fa-search-minus fa-xs'></span></div>" +
                                    "</div>" +
                                    "<div class='gc-overlay-left-icons'>" +
                                        "<div class='gc-icon gc-icon-prev text-center'><span class='fas fa-chevron-left'></span></div>" +
                                    "</div>" +
                                    "<div class='gc-overlay-right-icons'>" +
                                        "<div class='gc-icon gc-icon-next text-center'><span class='fas fa-chevron-right'></span></div>" +
                                    "</div>" +
            ...
            var ctntThumbsPrevNext = "<div class='gc-thumbs-area-prev'><div class='gc-icon gc-icon-prev text-center " + sVT + "'><span class='fas fa-sm fa-sm fa-chevron-left'></span></div></div>" +
                                     "<div class='gc-thumbs-area-next'><div class='gc-icon gc-icon-next text-center " + sVT + "'><span class='fas fa-sm fa-sm fa-chevron-right'></span></div></div>";
